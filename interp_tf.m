function [transfer_function_new] = interp_tf(transfer_function_old, len_new)
% interp_tf interpolates the old transfer function transfer_function_old to 
% a new length of len_new.
